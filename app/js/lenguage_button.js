...
const qui6 = document.querySelector('.qui6');
...
function changeLenguage(attr) {
  ...
  qui6.textContent = data[attr].qui6;
...
var data = {
  "english":
  {
    ...
    "qui4": "What we do",
    "qui5": "Throughout the last three decades, PSM has participated in various initiatives intended to improve natural resources management alongside other lumber producers and has been certificated to comply with international standards.",
    "qui6": "It also maintains a close relationship with neighboring communities.",
  ...
  "spanish":
  {
    ...
    "qui2": "Dónde estamos",
    "qui3": "Localizada en el municipio de Chignahuapan, en el estado mexicano de Puebla; incorpora varios predios boscosos con árboles de las especies  pino y oyamel predominantemente (Pinus patula, Pinus montezumae, Pinus ayacahuite; Abies religiosa).",
    "qui4": "Lo que hacemos",
    "qui5": "Durante estas tres últimas décadas PSM ha participado en diversas iniciativas encaminadas al mejor manejo del recurso natural junto con otros productores forestales, y de manera individual a través de la certificación internacional de sus actividades.",
    "qui6": "De igual manera, mantiene un acercamiento constante y una buena vecindad con la comunidad que le rodea.",
